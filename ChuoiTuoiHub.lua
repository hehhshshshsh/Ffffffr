...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://16565778952"
...
ImageButton1.Image = "rbxassetid://16565778952"
...
function Update:Window(text,logo,keybind)
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
    ...
    UserImage.Image = "rbxassetid://16565778952"
	...
	Logo.Image = "rbxassetid://16565778952"
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://16565778952"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://16565778952"
...
local Library = Update:Window(CHUỐI TƯƠI","",Enum.KeyCode.RightControl);
...
NguyenTien:AddLabel("Owner: NGUYEN VU DUY")
NguyenTien:AddLabel("Support Script: Lynx (My Girl Friend)")
NguyenTien:AddLabel("Ui: Nguyễn Vũ Duy Hub")
NguyenTien:AddLabel("Cảm ơn Bạn Đã Dùng Script")
...
setclipboard("https://www.youtube.com/@PHULUS_LAG_VN")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
NguyenTien:AddButton("ZALO CHAT 2",function()
...
SoundSFX.SoundId = "rbxassetid://16565778952"
SoundSFX:Play()
...
Misc:AddButton("Kaitun Cap", function(value)
		...
		for k,v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..v,true) == 1 then 
				...
				huhu.Image = "rbxassetid://16565778952"
